...
public class frmDangKyPhong extends javax.swing.JInternalFrame 
{
    ...
    private void initComponents() {
        ...
        jPanel4.getAccessibleContext().setAccessibleName("Danh sach phòng");

        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Thêm khách thuê"));

        buttonGroup1.add(rbtnKhachThueMoi);
        rbtnKhachThueMoi.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        rbtnKhachThueMoi.setForeground(new java.awt.Color(0, 153, 204));
        ...
        rbtnKhachOGhep.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        rbtnKhachOGhep.setForeground(new java.awt.Color(0, 153, 204));
        ...
        btnThemKhach.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnThemKhach.setForeground(new java.awt.Color(0, 153, 153));
