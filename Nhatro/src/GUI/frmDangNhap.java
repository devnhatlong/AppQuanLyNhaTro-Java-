...
public class frmDangNhap extends javax.swing.JInternalFrame 
{
    ...
    private void btnDangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangNhapActionPerformed
        ...
        try {
            ...
            {
                if(dangnhap.KiemtraTaiKhoanNV(dangnhapEntity).next() == false)//Nếu như resultSet không trả về hàng nào
                {
                ...
                main_frame.getJMenuBar().getMenu(0).setEnabled(false);
                main_frame.getJMenuBar().getMenu(1).setEnabled(true);
                main_frame.getJMenuBar().getMenu(1).getMenuComponent(1).setVisible(false);
                main_frame.getJMenuBar().getMenu(2).setEnabled(false);
                main_frame.getJMenuBar().getMenu(3).setEnabled(false);
                main_frame.getJMenuBar().getMenu(4).setEnabled(false);
            ...
            else
            {
                ...
                main_frame.getJMenuBar().getMenu(1).setEnabled(true);
                main_frame.getJMenuBar().getMenu(1).getMenuComponent(1).setVisible(true);
...
//                //Hiện tất cả các menu 
//                main_frame.getJMenuBar().getMenu(0).setEnabled(true);
//                main_frame.getJMenuBar().getMenu(1).setEnabled(false);
//                main_frame.getJMenuBar().getMenu(2).setEnabled(false);
//                main_frame.getJMenuBar().getMenu(3).setEnabled(false);
//                main_frame.getJMenuBar().getMenu(4).setEnabled(false);
//                main_frame.getJMenuBar().getMenu(5).getMenuComponent(0).setVisible(false);//tắt item Đăng nhập
